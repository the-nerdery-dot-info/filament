...
Bookmark<FLOAT> Bookmark<FLOAT>::interpolateMap(Bookmark<FLOAT> a, Bookmark<FLOAT> b, double t) {
...
template <typename FLOAT>
Bookmark<FLOAT> Bookmark<FLOAT>::interpolateOrbit(Bookmark<FLOAT> a, Bookmark<FLOAT> b, double t) {
    Bookmark<FLOAT> result;
...
template <typename FLOAT>
double Bookmark<FLOAT>::durationMap(Bookmark<FLOAT> a, Bookmark<FLOAT> b) {
    const double rho = sqrt(2.0);
    const double rho2 = 2, rho4 = 4;
    const double ux0 = a.map.center.x, uy0 = a.map.center.y, w0 = a.map.extent;
    const double ux1 = b.map.center.x, uy1 = b.map.center.y, w1 = b.map.extent;
